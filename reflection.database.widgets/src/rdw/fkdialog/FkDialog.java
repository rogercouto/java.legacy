 ...
 * @author Roger
 */
public class FkDialog extends Composite implements DbControl {
	 ...
	 * @param style
	 */
	public FkDialog(Composite parent, int style) {
	...
	private void initialize() {
		...
		//lblAviso.setImage(SWTResourceManager.getImage(FkDialog.class, "/rdw/icon/aviso.png"));
