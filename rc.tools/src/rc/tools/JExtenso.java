...
import java.util.Iterator;
    ...
    public class JExtenso {  
       ...
       public static String getPString(double value){
    	   JExtenso extenso = new JExtenso(value);
    	   return extenso.toPercentString();
       }
       ...
       public static String getObs(int value){
    	   JExtenso extenso = new JExtenso(value);
    	   return value+"("+extenso.getObs()+")";
       }
       
       public static String getString(double value, String c, int size){
    	   JExtenso extenso = new JExtenso(value);
    	   String vExtenso = extenso.toString();
    	   int increment = (size - vExtenso.length()) / c.length();
